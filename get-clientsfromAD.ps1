...
Get-ADComputer -Filter {OperatingSystemVersion -Like '*4.0*' -and LastLogonDate -ge $lastMonth} | Measure-Object | Select-Object -ExpandProperty Count
...
$CompList | Export-Csv -Path 'E:\M365Storage\clients.csv'